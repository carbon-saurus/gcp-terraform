...
#   service_account_id = var.gcr_sa_email
#   lifecycle {
#     prevent_destroy = true
#   }
# }
...
#   member  = "serviceAccount:${var.gcr_sa_email}"
...
#   members  = [
#     "serviceAccount:${var.cloud_sql_proxy_sa_email}"
...
#   service_account_id = var.cloud_sql_proxy_sa_email
...
#   role    = "roles/secretmanager.secretAccessor"
#   members = [
#     "serviceAccount:${var.external_secret_sa_email}"
...
#   service_account_id = var.external_secret_sa_email
